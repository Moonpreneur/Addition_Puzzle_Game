...
const draggableValues = [
    { id: "value1", value: "456+989" },
    { id: "value2", value: "453+99" },
    { id: "value3", value: "879+657" },
    { id: "value4", value: "77+789" },
    { id: "value5", value: "212+989" },
    { id: "value6", value: "565+121" },
    { id: "value7", value: "656+121" },
    { id: "value8", value: "565+765" }
...
startGameBtn1.addEventListener('click', () => {
    ...
    startGameBtn2.classList.remove('hidden'); // Show the button on page 2
});

// Show Page 3 (Game Board)
startGameBtn2.addEventListener('click', () => {
    page2.classList.add('hidden');
    startGameBtn2.classList.add('hidden'); // Hide the button when starting the game
